...
const CategoryBlogPage = ()=>{
    ...
    const [trendBlog, setTrendBlog] = useState(categoryName)
    ...
    const categoryFun = (e)=>{
        setTrendBlog(e.target.value)
        navigate(`/category-blog/${e.target.value}`)
    }
    return(
        <>
            <div className="trending-blog-container">
                <h1 className='text-center'>Trending Blogs section </h1>
                <select name="blog-group" id="blog-group" onChange={categoryFun}>
